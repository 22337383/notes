...
$(function(){
	// 初始化表情包 
	var $faces = $("<div class='box'></div>")
	for(var key in userFaces){
		var $imgs = $("<img src = 'faces/"+key+"' alt='"+userFaces[key]+"'>");
		$imgs.appendTo($faces);
	}
	// 插入表情包
	$faces.appendTo($(".insertFace"));
	...
	$faces.on("click","img",function(){
		var $faceTxt = $(this).attr("alt");
		// 追加内容
		$("#msgTxt").text($("#msgTxt").text() + "["+$faceTxt+"]")
	})
